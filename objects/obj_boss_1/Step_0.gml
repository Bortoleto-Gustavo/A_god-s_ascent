...
switch (state) {
    ...
    case HANG_STATE.DEAD:
        ...
        // Destruir o objeto do boss e ir para a sala de fim de jogo
        instance_destroy();
		go_to_next_level();
        break;
}
