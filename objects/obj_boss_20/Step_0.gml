...
switch (state) {
	...
	case BOSS_STATE_MOON.ATTACKING:
...
//MODIFICAR STATE DE ACORDO COM O NOME DO SEU BOSS
if (hp <= 0 && state != BOSS_STATE_MOON.DEAD) {
    show_debug_message("Boss MORREU!");
    state = BOSS_STATE_MOON.DEAD;
...
if (heart_anim_frame >= sprite_get_number(spr_heart_full_moon))
{
    heart_anim_frame = 0;
}